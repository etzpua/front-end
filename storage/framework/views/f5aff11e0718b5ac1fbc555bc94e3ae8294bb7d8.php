...
<?php $__env->startSection('content'); ?>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="<?php echo e(route('createUser')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="mesto_raboti" type="text" id="simpleinput" class="form-control">
                                </div>

                                <!-- tel -->
                                <div class="form-group">
                                    <label class="form-label" for="simpleinput">Номер телефона</label>
                                    <input name="telefon" type="text" id="simpleinput" class="form-control">
                                </div>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OpenServer\domains\laravel3\resources\views/create.blade.php ENDPATH**/ ?>